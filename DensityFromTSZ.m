function [pden,den] = DensityFromTSZ(T,S,Zr)
%% DensityFromTSZ
%
% March 7th, 2022 --- Jeffrey J. Early
%
% Taken from roms-matlab/utility/eos.m, svn $Id: eos.m 1102 2022-01-06 21:50:44Z arango $
%
% Computes potential density and in-situ density from temp, salinity and
% the z-coordinate for rho (Zr).
%
% The density calculation does appear to return the same in-situ value that
% is saved.
...
pden = Q00 + Q01.*T + Q02.*T.^2 + Q03.*T.^3 + Q04.*T.^4 + Q05.*T.^5 + ...
